...
class Ajax extends CI_Controller {
	...
	function upload(){	
		...
		$source='http://marketmap.me/timthumb?src=http://marketmap.me/'.$dest;
	...
	function get_img(){	
			...
			if (isset($array['data']['error'])){				
				...
				if (isset($array['data']['relationships']['primary_image']['items'][0]['path']) && isset($array['metadata']['image_path_prefix'])){
					...
					$source='http://marketmap.me//timthumb?src='.$array['metadata']['image_path_prefix'].$array['data']['relationships']['primary_image']['items'][0]['path'];
					$source=$source."&h=100&w=100&zc=2";
			...
			$source='http://marketmap.me/timthumb?src=http'.$originalimg;
			//echo $source;
			$source=$source."&h=100&w=100&zc=2";						
