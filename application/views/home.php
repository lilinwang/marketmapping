        ...
        <div id="page-wrapper">
            <div class="container-fluid">
				...
				<div id="myImage" style="margin-top:40px">
					<div class="map-title">
						<input type="text" id="canvas_title" placeholder="Tittle of Map" style="width:100%;text-align:center;border: 0px solid;background-color: transparent;">											
					</div>
					...
					<div class="label-top">						   			         		      	  				  
						<input type="text" id="axis_top" onkeyup="autocomplet(this)" placeholder="Y Axis" style="border: 0px solid;background-color: transparent;">
						<ul id="axis_top_list"></ul>
					</div>
					<div class="label-bottom">
						<input type="text" id="axis_bottom" onkeyup="autocomplet(this)" placeholder="Y Axis" style="border: 0px solid;background-color: transparent;">
						<ul id="axis_bottom_list"></ul> 			         		      	  				  
					</div>
					<div class="label-left">     			        
						<input type="text" id="axis_left" onkeyup="autocomplet(this)" placeholder="X Axis" style="border: 0px solid;background-color: transparent;">
						<ul id="axis_left_list"></ul>
					</div>
					<div class="label-right">   	
						<input type="text" id="axis_right" onkeyup="autocomplet(this)" placeholder="X Axis" style="border: 0px solid;background-color: transparent;">
