...
<body>
    ...
    <header class="intro-header" style="background-image: url('img/axis.jpg')">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        <h1 style="color:#C34848">Why Market Maps Matter</h1>
                        <h2 class="subheading" style="color:#C34848">Rethinking Competitive Market Mapping</h2>
                        <span class="meta" style="color:#373737">Posted by <a style="color:#C34848" href="about">CornellTech Students</a> on December 5th, 2014</span>
                    </div>
                </div>
            </div>
        </div>
...
map was a very unique and generally non-repeatable endeavor.</p>
                    ...
                    <blockquote>An XY Market Map is used to compare the players in a given industry on two

dimensions.  It should be used to demonstrate how your company is superior to its 
...
play.  It should be used to illustrate that your company serves a variety of industries 
...
positioning companies relative to one another on the map, and which axes users are selecting to 

compare related companies.  Over time, this repository of data will allow us to recommend 

market map styles, relevant competitors, axes for comparison, and relative positioning of 

companies on competitive landscapes.  marketmap.me will quantify previously unquantifiable 

comparison dimensions for new, developing industries; and has the potential to become the 

standard, objective means for competitive market mapping.</p>
